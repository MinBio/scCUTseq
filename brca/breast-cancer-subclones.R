...
clones = fread("/mnt/AchTeraD/Documents/Projects/scCUTseq/data/brca/NZ169-174_clones.tsv")
setorder(clones, V2)
# Set threads
nthreads = 32
...
save_and_plot(plt, "/mnt/AchTeraD/Documents/Projects/scCUTseq/Plots/brca/subclones-heatmap",
              width = 20, height = 12)
