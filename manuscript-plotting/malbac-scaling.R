...
# Plot
plot = ggplot(total, aes(x = sample, y = value)) +
  geom_violin(aes(fill = sample, color = sample)) +
  geom_boxplot(width = 0.05, outlier.size = 1, size = .7) +
  ...
  labs(y = "Pearson's Correlation", x = "MALBAC scaling") + 
  theme(legend.position = "none") 

save_and_plot(plot, "/mnt/AchTeraD/Documents/Projects/scCUTseq/Plots/manuscript/malbac_scaling/BICRO226_227-malbac_scaling",
              height = 7, width = 7)
