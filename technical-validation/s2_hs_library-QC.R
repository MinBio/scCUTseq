...
all_hs <- fread("/mnt/AchTeraD/data/BICRO220/NZ63/hs/all.tsv", select = c(1, 9))
dedup_hs <- fread("/mnt/AchTeraD/data/BICRO220/NZ63/hs/dedup.tsv", select = c(1, 9))
all_s2 <- fread("/mnt/AchTeraD/data/BICRO220/NZ63/dm/all.tsv", select = c(1, 9))
dedup_s2 <- fread("/mnt/AchTeraD/data/BICRO220/NZ63/dm/dedup.tsv", select = c(1, 9))
...
save_and_plot(plt, "/mnt/AchTeraD/Documents/Projects/scCUTseq/Plots/sequencing_QC/BICRO220+217/NZ26_all-cells", height = 8, width = 8)
